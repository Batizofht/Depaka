  ...
  const services = [
    {
      ...
      description:
        "Direct access to certified gold and silver bullion bars sourced from world-class refineries. Expert pricing and transparent market rates.",
    },
    {
      icon: "bridal" as ServiceIcon,
      title: "Investment Plans",
      description:
        "Customized precious metals investment strategies designed for long-term wealth preservation and portfolio diversification.",
    },
    {
      icon: "gemstone" as ServiceIcon,
      title: "Coins & Collectibles",
      description:
        "Rare investment-grade coins and limited edition collectibles with verified authenticity and certification documentation.",
    },
    {
      icon: "heritage" as ServiceIcon,
      title: "Market Consultation",
      description:
        "Expert guidance from seasoned traders on market trends, optimal entry points, and investment timing strategies.",
    },
    {
      icon: "restoration" as ServiceIcon,
      title: "Secure Storage",
      description:
        "Insured vault storage facilities with insurance coverage and regular verification of holdings.",
    },
    {
      icon: "investment" as ServiceIcon,
      title: "Buy-Back Program",
      description:
        "Competitive buy-back rates ensuring liquidity and flexibility in managing your precious metals portfolio.",
    },
  ];
  ...
  const processSteps = [
    {
      ...
      text: "We analyze current market conditions and help you identify optimal investment opportunities based on your financial goals.",
    ...
    },
    {
      ...
      text: "Choose from our curated selection of certified bullion, coins, or customized solutions tailored to your investment strategy.",
    ...
    },
    {
      ...
      text: "Complete transparent pricing and authenticated documentation ensure secure delivery of your precious metals.",
    ...
    },
    {
      ...
      text: "Continuous market updates, buy-back options, and expert guidance to optimize your precious metals portfolio.",
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 text-center">
          <div>
            ...
            <p className="mt-3 text-[rgba(255,255,255,0.88)] font-manrope text-sm sm:text-[15px] leading-6 max-w-[540px] mx-auto">
              Delivering trusted precious metals trading expertise and investment solutions.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#FAF8F4] py-16 sm:py-20 lg:py-24 px-4 sm:px-8 lg:px-28">
        <div className="max-w-[1408px] mx-auto flex flex-col items-center text-center">
          ...
          <h2 className="mt-3 text-[#161616] font-playfairDisplay text-[30px] sm:text-[36px] lg:text-[40px] leading-tight max-w-[588px]">
            Begin Building Your Precious Metals Portfolio
          </h2>
          <p className="mt-4 text-[rgba(45,45,66,0.55)] font-manrope text-sm sm:text-[15px] leading-[25.84px] max-w-[448px]">
            Connect with our expert traders and discover investment opportunities tailored to your goals.
          </p>
          <button
            type="button"
