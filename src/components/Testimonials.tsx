...
const testimonials = [
  {
    ...
    quote: "Venaxa Gold's investment portfolio guidance helped me secure my family's wealth. Their transparency and expert market knowledge are unmatched.",
    image: "/Tests/Mainpic_one.svg",
    avatar: "/Tests/Button.png"
  },
  {
    id: 2,
    name: "Anita Desai",
    role: "Gold Collector, Delhi",
    quote: "Every bullion piece I own from Venaxa is certified and authentic. Their attention to detail in quality assurance sets them apart.",
    image: "https://images.unsplash.com/photo-1759386850821-7b63d7f5af08?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    avatar: "/Tests/Button2.png"
  },
  {
    id: 3,
    name: "Meera Patel",
    role: "Customer",
    quote: "I've invested in Venaxa Gold's precious metals platform and been consistently impressed. Their security standards and transparent pricing give me complete confidence.",
    image: "/Pics/GoldDesign.svg",
    avatar: "/Tests/Button3.png"
  }
];
