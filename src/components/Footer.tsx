      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 w-full">
        ...
        <div className="flex flex-col items-start gap-4 sm:gap-6">
          ...
          <p className="text-[rgba(255,255,255,0.50)] font-manrope text-sm leading-[23px] max-w-[295px]">
            Premier precious metals trading since 1987. Blending heritage craftsmanship with modern investments in fine gold and silver.
          </p>
        ...
        <div className="flex flex-col items-start gap-4 sm:gap-6">
          ...
          <div className="flex flex-col items-start gap-3">
            ...
            <Link to="/vision" className="text-[rgba(255,255,255,0.50)] font-manrope text-sm hover:text-[#D19C2A] transition-colors">Our Vision</Link>
        ...
        <div className="flex flex-col items-start gap-4 sm:gap-6">
          ...
          <div className="flex flex-col items-start gap-3">
            <p className="text-[rgba(255,255,255,0.50)] font-manrope text-sm">Gold Bars & Coins</p>
            <p className="text-[rgba(255,255,255,0.50)] font-manrope text-sm">Silver Bars & Coins</p>
            <p className="text-[rgba(255,255,255,0.50)] font-manrope text-sm">Customized Solutions</p>
            <p className="text-[rgba(255,255,255,0.50)] font-manrope text-sm">Wholesale Trading</p>
            <p className="text-[rgba(255,255,255,0.50)] font-manrope text-sm">Investment Consultation</p>
          </div>
        </div>
